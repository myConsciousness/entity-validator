...
public enum RegexModifier implements BiCatalog<RegexModifier, RegexOption> {
     ...
     * expression&nbsp;{@code (?d)}.
     */
    UNIX_LINES(0, RegexOption.UNIX_LINES),
     ...
     * </p>
     */
    CASE_INSENSITIVE(1, RegexOption.CASE_INSENSITIVE),
     ...
     * expression&nbsp;{@code (?x)}.
     */
    COMMENTS(2, RegexOption.COMMENTS),
     ...
     * </p>
     */
    MULTILINE(3, RegexOption.MULTILINE),
     ...
     * </p>
     */
    UNICODE_CASE(6, RegexOption.UNICODE_CASE),
     ...
     * </p>
     */
    CANON_EQ(7, RegexOption.CANON_EQ),
     ...
     * </p>
     */
    UNICODE_CHARACTER_CLASS(8, RegexOption.UNICODE_CHARACTER_CLASS);
