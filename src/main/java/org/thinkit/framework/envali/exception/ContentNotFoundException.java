 ...
 * {@link ParameterMapping} interface has detected an invalid content path.
 *
 * @author Kato Shinya
 * @since 1.0
 * @version 1.0
...
public final class ContentNotFoundException extends RuntimeException {
    ...
    /**
     * Constructs an <code>ContentNotFoundException</code> with no detail message.
     */
    ...
    /**
     * Constructs an <code>ContentNotFoundException</code> with the specified detail
     * message.
     *
