...
final class RequireRangeFromToStrategy extends ValidationStrategy {
     ...
     */
    private RequireRangeFromToStrategy(@NonNull ValidatableEntity entity, @NonNull Field field) {
        super(entity, field);
    }
    ...
    public void validate() {
        Preconditions.requireRange(super.getFieldHelper().getInt(),
                Integer.parseInt(super.getEnvaliContent().get(EnvaliContentAttribute.RANGE_FROM.getTag())),
