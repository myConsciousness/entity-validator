 ...
 * when testing the {@link Envali} and the {@link RequirePositive} annotation.
 *
 * @author Kato Shinya
 * @since 1.0.2
 */
final class UnsupportedRequirePositiveForTest implements ValidatableEntity {
    ...
    private UnsupportedRequirePositiveForTest() {
    }
     ...
     */
    public UnsupportedRequirePositiveForTest(String literal) {
