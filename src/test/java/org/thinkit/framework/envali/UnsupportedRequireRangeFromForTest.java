 ...
 * @since 1.0.2
 */
final class UnsupportedRequireRangeFromForTest implements ValidatableEntity {
    ...
    private UnsupportedRequireRangeFromForTest() {
    }

    /**
     * Constructor
     *
     * @param literal The unsupported object
     */
    public UnsupportedRequireRangeFromForTest(String literal) {
