 ...
 * @since 1.0.0
 */
final class RequireNonEmptyForTest implements ValidatableEntity {
    ...
    private RequireNonEmptyForTest() {
    }
     ...
     */
    public RequireNonEmptyForTest(String literal, String[] literalArray, List<String> literalList,
