 ...
 * {@link Envali} interface and the {@link RequireMatch} annotation with find
 * method.
 *
 * @author Kato Shinya
 * @since 1.0.2
 */
public class RequireMatchOfEmailAddressWithFindMethodForTest implements ValidatableEntity {

    /**
     * The email address
     */
    @RequireMatch(presetExpression = RegexPreset.EMAIL_ADDRESS, errorType = ErrorType.RECOVERABLE, message = "success")
    ...
    private RequireMatchOfEmailAddressWithFindMethodForTest() {
    }
     ...
     */
    public RequireMatchOfEmailAddressWithFindMethodForTest(String emailAddress) {
