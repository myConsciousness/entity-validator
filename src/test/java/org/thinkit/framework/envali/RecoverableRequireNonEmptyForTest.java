 ...
 * {@link Envali} interface and the recoverable {@link RequireNonEmpty}
 * annotation.
 *
 * @author Kato Shinya
 * @since 1.0.1
 */
final class RecoverableRequireNonEmptyForTest implements ValidatableEntity {

    /**
     * The non empty literal
     */
    @RequireNonEmpty(errorType = ErrorType.RECOVERABLE, message = "success")
    ...
    private RecoverableRequireNonEmptyForTest() {
    }
     ...
     */
    public RecoverableRequireNonEmptyForTest(String literal, String[] literalArray, List<String> literalList,
