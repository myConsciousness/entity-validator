 ...
 * {@link Envali} interface and the unrecoverable {@link RequireEndWith}
 * annotation.
 *
 * @author Kato Shinya
 * @since 1.0.1
...
final class UnrecoverableRequireEndWithForTest implements ValidatableEntity {

    /**
     * The literal expected to end with specified suffix
     */
    @RequireEndWith(errorType = ErrorType.UNRECOVERABLE, message = "success")
    ...
    private UnrecoverableRequireEndWithForTest() {
    }
     ...
     */
    public UnrecoverableRequireEndWithForTest(String literal) {
