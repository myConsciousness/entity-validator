 ...
 * @since 1.0.2
 */
final class UnsupportedRequireNonBlankForTest implements ValidatableEntity {
    ...
    private UnsupportedRequireNonBlankForTest() {
    }

    /**
     * Constructor
     *
     * @param number The unsupported value
     */
    public UnsupportedRequireNonBlankForTest(int number) {
        this.number = number;
    }
}
