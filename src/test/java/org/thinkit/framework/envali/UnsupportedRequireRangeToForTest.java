 ...
 * @since 1.0.2
 */
final class UnsupportedRequireRangeToForTest implements ValidatableEntity {
    ...
    private UnsupportedRequireRangeToForTest() {
    }
     ...
     */
    public UnsupportedRequireRangeToForTest(StringBuilder sb) {
        this.sb = sb;
    }
}
