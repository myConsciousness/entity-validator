...
final class RequireStartWithForTest implements ValidatableEntity {

    /**
     * The literal expected to start with specified prefix
     */
    @RequireStartWith
    ...
    private RequireStartWithForTest() {
    }

    /**
     * Constructor
     *
     * @param literal The literal expected to start with specified prefix
     */
    public RequireStartWithForTest(String literal) {
