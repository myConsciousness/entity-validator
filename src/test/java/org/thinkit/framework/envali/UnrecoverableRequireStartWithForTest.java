 ...
 * {@link Envali} interface and the unrecoverable {@link RequireStartWith}
 * annotation.
 *
 * @author Kato Shinya
 * @since 1.0.1
...
final class UnrecoverableRequireStartWithForTest implements ValidatableEntity {

    /**
     * The literal expected to end with specified prefix
     */
    @RequireStartWith(errorType = ErrorType.UNRECOVERABLE, message = "success")
    ...
    private UnrecoverableRequireStartWithForTest() {
    }
     ...
     */
    public UnrecoverableRequireStartWithForTest(String literal) {
